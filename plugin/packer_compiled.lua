...
_G.packer_plugins = {
  ...
  extensions = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/extensions"
  },
  ["feline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/feline.nvim"
  },
  ["friendly-snippets"] = {
    after = { "nvim-cmp" },
    loaded = false,
  ...
  ["nvim-base16.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/nvim-base16.lua"
  },
  ["nvim-cmp"] = {
  ...
  ["nvim-comment"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/user/.local/share/nvim/site/pack/packer/opt/nvim-comment"
  },
  ["nvim-lspconfig"] = {
  ...
  ["presence.nvim"] = {
    config = { "\27LJ\2\n=\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\"custom.plugins_confs.presence\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'better-escape.nvim', 'presence.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
